...
**_This repository contains unofficial packaging for an installation of [ESLint-plugin-React](https://github.com/yannickcr/eslint-plugin-react).  It is not affiliated, authorized, endorsed by, or in other way connected with either Arch Linux or the ESLint project._**
